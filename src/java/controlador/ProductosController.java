...
import modelo.dao.ProductosFacade;
...
public class ProductosController implements Serializable {
    ...
    @EJB
    private modelo.dao.ProductosFacade ejbFacade;
    ...
    public void create() {
        persist(PersistAction.CREATE, ResourceBundle.getBundle("/Vista").getString("ProductosCreated"));
    ...
    public void update() {
        persist(PersistAction.UPDATE, ResourceBundle.getBundle("/Vista").getString("ProductosUpdated"));
    }

    public void destroy() {
        persist(PersistAction.DELETE, ResourceBundle.getBundle("/Vista").getString("ProductosDeleted"));
        if (!JsfUtil.isValidationFailed()) {
    ...
    public Productos getProductos(java.math.BigDecimal id) {
