...
import modelo.dao.VentasFacade;
...
public class VentasController implements Serializable {
    ...
    @EJB
    private modelo.dao.VentasFacade ejbFacade;
    ...
    public void create() {
        persist(PersistAction.CREATE, ResourceBundle.getBundle("/Vista").getString("VentasCreated"));
    ...
    public void update() {
        persist(PersistAction.UPDATE, ResourceBundle.getBundle("/Vista").getString("VentasUpdated"));
    }

    public void destroy() {
        persist(PersistAction.DELETE, ResourceBundle.getBundle("/Vista").getString("VentasDeleted"));
        if (!JsfUtil.isValidationFailed()) {
    ...
    public Ventas getVentas(java.math.BigDecimal id) {
