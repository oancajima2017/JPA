...
import modelo.dao.ModalidadFacade;
...
public class ModalidadController implements Serializable {
    ...
    @EJB
    private modelo.dao.ModalidadFacade ejbFacade;
    ...
    public void create() {
        persist(PersistAction.CREATE, ResourceBundle.getBundle("/Vista").getString("ModalidadCreated"));
    ...
    public void update() {
        persist(PersistAction.UPDATE, ResourceBundle.getBundle("/Vista").getString("ModalidadUpdated"));
    }

    public void destroy() {
        persist(PersistAction.DELETE, ResourceBundle.getBundle("/Vista").getString("ModalidadDeleted"));
        if (!JsfUtil.isValidationFailed()) {
    ...
    public Modalidad getModalidad(java.math.BigDecimal id) {
